...
------------- | ------------- | -------------
[**get**](BalanceTransactionsApi.md#get) | **GET** /v1/balance-transactions/{id} | Get a Balance Transaction
[**getSummary**](BalanceTransactionsApi.md#getSummary) | **GET** /v1/balance-transactions/summary | Get a Balance Transactions Summary
[**list**](BalanceTransactionsApi.md#list) | **GET** /v1/balance-transactions | List all Balance Transactions
...
const getResponse = await tilled.balanceTransactions.get({
  id: "id_example",
});
...
#### **GET** /v1/balance-transactions/summary
...
const getSummaryResponse = await tilled.balanceTransactions.getSummary({
  timeUnit: "month",
  timeZone: "America/Chicago",
  includeConnectedAccounts: false,
});

console.log(getSummaryResponse);
```
...
const listResponse = await tilled.balanceTransactions.list({
  type: "charge",
  offset: 0,
  limit: 30,
});
 ...
 **type** | 'charge', 'charge_failure_refund', 'dispute', 'dispute_won', 'refund', 'refund_failure', 'adjustment', 'commission', 'payout', 'payout_cancel', 'payout_failure', 'fee', 'platform_fee', 'platform_fee_refund', 'outbound_transfer', 'outbound_transfer_cancel', 'outbound_transfer_failure', 'charge_fee', 'refund_fee', 'account_fee', 'payment_method_fee', 'tilled_fee' | Only return transaction of the given type. | (optional) defaults to undefined
 **sourceId** | [**string**] | Only returns the original transaction. | (optional) defaults to undefined
 **payoutId** | [**string**] | Only returns transactions that were paid out on the specified payout ID. | (optional) defaults to undefined
...
**BalanceTransactionsListResponse**
