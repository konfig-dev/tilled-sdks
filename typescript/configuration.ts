...
export class Configuration {
    ...
    constructor(param: ConfigurationParameters = {}) {
        ...
        if (this.apiKey === undefined) {
            this.apiKey = {}
            if (param.TilledAccount !== undefined)
                this.apiKey["tilled-account"] = param.TilledAccount
            if (param.TilledApiKey !== undefined)
                this.apiKey["tilled-api-key"] = param.TilledApiKey
        }
