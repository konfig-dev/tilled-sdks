...
import { TilledCustom } from "./client-custom";

export class Tilled extends TilledCustom {
  readonly apiKeys: ApiKeysApi;
  readonly accounts: AccountsApi;
  readonly applepaydomains: ApplepaydomainsApi;
  readonly authLinks: AuthLinksApi;
  ...
  readonly outboundTransfers: OutboundTransfersApi;
  readonly paymentintents: PaymentintentsApi;
  readonly paymentmethods: PaymentmethodsApi;
  readonly payouts: PayoutsApi;
  readonly platformFeeRefunds: PlatformFeeRefundsApi;
  readonly platformFees: PlatformFeesApi;
  readonly pricingTemplates: PricingTemplatesApi;
  readonly productcodes: ProductcodesApi;
  readonly refunds: RefundsApi;
  readonly reportruns: ReportrunsApi;
  ...
  constructor(configurationParameters: ConfigurationParameters) {
    ...
    this.applepaydomains = new ApplepaydomainsApi(configuration);
    this.authLinks = new AuthLinksApi(configuration);
    this.balanceTransactions = new BalanceTransactionsApi(configuration);
    this.charges = new ChargesApi(configuration);
    ...
    this.outboundTransfers = new OutboundTransfersApi(configuration);
    ...
    this.platformFeeRefunds = new PlatformFeeRefundsApi(configuration);
    this.platformFees = new PlatformFeesApi(configuration);
    this.pricingTemplates = new PricingTemplatesApi(configuration);
    this.productcodes = new ProductcodesApi(configuration);
    this.refunds = new RefundsApi(configuration);
    this.reportruns = new ReportrunsApi(configuration);
    this.subscriptions = new SubscriptionsApi(configuration);
    this.users = new UsersApi(configuration);
    this.webhookendpoints = new WebhookendpointsApi(configuration);
  }
