...
// @ts-ignore
import { RefundCreateParams } from '../models';
// @ts-ignore
import { RefundsListResponse } from '../models';
import { paginate } from "../pagination/paginate";
import { requestBeforeHook } from '../requestBeforeHook';
import { RefundsApiCustom } from "./refunds-api-custom";
/**
...
export const RefundsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        create: async (refundCreateParams: RefundCreateParams, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'refundCreateParams' is not null or undefined
            assertParamExists('create', 'refundCreateParams', refundCreateParams)
            ...
            requestBeforeHook({
                requestBody: refundCreateParams,
         ...
         * @throws {RequiredError}
         */
        list: async (metadata?: { [key: string]: string; }, offset?: number, limit?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/refunds`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const RefundsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * When you create a new refund, you must specify a PaymentIntent object on which to create it.  Creating a new refund will refund a charge that has previously been created but not yet refunded. Funds will be refunded to the original payment method.  You can optionally refund only part of a charge. You can do so multiple times, until the entire charge has been refunded.  Once entirely refunded, a charge can\'t be refunded again. This method will throw an error when called on an already-refunded charge, or when trying to refund more money than is left on a charge.
         * @summary Create a Refund
         * @param {RefundsApiCreateRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async create(requestParameters: RefundsApiCreateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Refund>> {
         ...
         * Retrieves the details of an existing refund.
         * @summary Get a Refund
         * @param {RefundsApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: RefundsApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Refund>> {
         ...
         * Returns a list of Refunds. The refunds are returned in a sorted order, with the most recent refunds appearing first.
         * @summary List all Refunds
         * @param {RefundsApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: RefundsApiListRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RefundsListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(requestParameters.metadata, requestParameters.offset, requestParameters.limit, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const RefundsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        create(requestParameters: RefundsApiCreateRequest, options?: AxiosRequestConfig): AxiosPromise<Refund> {
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: RefundsApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<Refund> {
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: RefundsApiListRequest = {}, options?: AxiosRequestConfig): AxiosPromise<RefundsListResponse> {
...
/**
 * Request parameters for create operation in RefundsApi.
 * @export
 * @interface RefundsApiCreateRequest
 */
export type RefundsApiCreateRequest = {
    
} & RefundCreateParams

/**
 * Request parameters for get operation in RefundsApi.
 * @export
 * @interface RefundsApiGetRequest
 */
export type RefundsApiGetRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof RefundsApiGet
    */
    readonly id: string
...
/**
 * Request parameters for list operation in RefundsApi.
 * @export
 * @interface RefundsApiListRequest
 */
export type RefundsApiListRequest = {
 ...
 * @extends {BaseAPI}
 */
export class RefundsApi extends RefundsApiCustom {
    /**
     * When you create a new refund, you must specify a PaymentIntent object on which to create it.  Creating a new refund will refund a charge that has previously been created but not yet refunded. Funds will be refunded to the original payment method.  You can optionally refund only part of a charge. You can do so multiple times, until the entire charge has been refunded.  Once entirely refunded, a charge can\'t be refunded again. This method will throw an error when called on an already-refunded charge, or when trying to refund more money than is left on a charge.
     * @summary Create a Refund
     * @param {RefundsApiCreateRequest} requestParameters Request parameters.
     ...
     * @memberof RefundsApi
     */
    public create(requestParameters: RefundsApiCreateRequest, options?: AxiosRequestConfig) {
        return RefundsApiFp(this.configuration).create(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RefundsApi
     */
    public get(requestParameters: RefundsApiGetRequest, options?: AxiosRequestConfig) {
        return RefundsApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RefundsApi
     */
    public list(requestParameters: RefundsApiListRequest = {}, options?: AxiosRequestConfig) {
        return RefundsApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
