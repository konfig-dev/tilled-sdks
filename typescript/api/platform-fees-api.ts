...
// @ts-ignore
import { PlatformFeesListResponse } from '../models';
import { paginate } from "../pagination/paginate";
import { requestBeforeHook } from '../requestBeforeHook';
import { PlatformFeesApiCustom } from "./platform-fees-api-custom";
/**
...
export const PlatformFeesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        list: async (createdAtGte?: string, createdAtLte?: string, chargeId?: string, offset?: number, limit?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const PlatformFeesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Retrieves the details of a platform fee that your account has collected. The same information is returned when when refunding the application fee.
         * @summary Get a Platform Fee
         * @param {PlatformFeesApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: PlatformFeesApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlatformFee>> {
         ...
         * Returns a list of platform fees you\'ve previously collected. The platform fees are returned in a sorted order, with the most recent fees appearing first.
         * @summary List all Platform Fees
         * @param {PlatformFeesApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: PlatformFeesApiListRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlatformFeesListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(requestParameters.createdAtGte, requestParameters.createdAtLte, requestParameters.chargeId, requestParameters.offset, requestParameters.limit, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const PlatformFeesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: PlatformFeesApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<PlatformFee> {
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: PlatformFeesApiListRequest = {}, options?: AxiosRequestConfig): AxiosPromise<PlatformFeesListResponse> {
...
/**
 * Request parameters for get operation in PlatformFeesApi.
 * @export
 * @interface PlatformFeesApiGetRequest
 */
export type PlatformFeesApiGetRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof PlatformFeesApiGet
    */
    readonly id: string
...
/**
 * Request parameters for list operation in PlatformFeesApi.
 * @export
 * @interface PlatformFeesApiListRequest
 */
export type PlatformFeesApiListRequest = {
    
    /**
    * Minimum `created_at` value to filter by (inclusive).
    * @type {string}
    * @memberof PlatformFeesApiList
    */
 ...
 * @extends {BaseAPI}
 */
export class PlatformFeesApi extends PlatformFeesApiCustom {
    /**
     * Retrieves the details of a platform fee that your account has collected. The same information is returned when when refunding the application fee.
     * @summary Get a Platform Fee
     * @param {PlatformFeesApiGetRequest} requestParameters Request parameters.
     ...
     */
    public get(requestParameters: PlatformFeesApiGetRequest, options?: AxiosRequestConfig) {
        return PlatformFeesApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PlatformFeesApi
     */
    public list(requestParameters: PlatformFeesApiListRequest = {}, options?: AxiosRequestConfig) {
        return PlatformFeesApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
