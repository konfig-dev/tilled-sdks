...
// @ts-ignore
import { HealthOutput } from '../models';
import { paginate } from "../pagination/paginate";
import { requestBeforeHook } from '../requestBeforeHook';
import { HealthApiCustom } from "./health-api-custom";
/**
...
export const HealthApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async get(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HealthOutput>> {
...
export const HealthApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        get(options?: AxiosRequestConfig): AxiosPromise<HealthOutput> {
 ...
 * @extends {BaseAPI}
 */
export class HealthApi extends HealthApiCustom {
    /**
     * A status of `pass` is healthy, `warn` is healthy with concerns, and `fail` is unhealthy.  *Note: a `503` HTTP response code will be returned for the `fail` status.*
     * @summary Get the Overall Health of the API
     * @param {*} [options] Override http request option.
