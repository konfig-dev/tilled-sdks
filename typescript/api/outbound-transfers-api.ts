...
// @ts-ignore
import { OutboundTransfer } from '../models';
// @ts-ignore
import { OutboundTransferCreateParams } from '../models';
// @ts-ignore
import { OutboundTransfersListResponse } from '../models';
import { paginate } from "../pagination/paginate";
import { requestBeforeHook } from '../requestBeforeHook';
import { OutboundTransfersApiCustom } from "./outbound-transfers-api-custom";
/**
...
export const OutboundTransfersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        create: async (outboundTransferCreateParams: OutboundTransferCreateParams, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'outboundTransferCreateParams' is not null or undefined
            assertParamExists('create', 'outboundTransferCreateParams', outboundTransferCreateParams)
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: outboundTransferCreateParams,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration
         ...
         * @throws {RequiredError}
         */
        list: async (metadata?: { [key: string]: string; }, status?: Array<'canceled' | 'failed' | 'pending' | 'succeeded'>, includeConnectedAccounts?: boolean, createdAtGte?: string, createdAtLte?: string, offset?: number, limit?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/outbound-transfers`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const OutboundTransfersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * An outbound transfer can be canceled only if its status is `pending` and funds have not yet been batched or paid out.  If the cancellation is successful, the OutboundTransfer object is returned.  If the outbound transfer cannot be canceled, an error is returned.
         * @summary Cancel an Outbound Transfer
         * @param {OutboundTransfersApiCancelRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async cancel(requestParameters: OutboundTransfersApiCancelRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OutboundTransfer>> {
         ...
         * If the creation request is successful, an OutboundTransfer object of status `pending` will be return.  If there is an error, an OutboundTransfer object with the status `failed` or an error is returned.
         * @summary Create an Outbound Transfer
         * @param {OutboundTransfersApiCreateRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async create(requestParameters: OutboundTransfersApiCreateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OutboundTransfer>> {
         ...
         * Retrieves the details of an outbound transfer.
         * @summary Get an Outbound Transfer
         * @param {OutboundTransfersApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: OutboundTransfersApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OutboundTransfer>> {
         ...
         * Returns a list of outbound transfers.
         * @summary List all Outbound Transfers
         * @param {OutboundTransfersApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: OutboundTransfersApiListRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OutboundTransfersListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(requestParameters.metadata, requestParameters.status, requestParameters.includeConnectedAccounts, requestParameters.createdAtGte, requestParameters.createdAtLte, requestParameters.offset, requestParameters.limit, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const OutboundTransfersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        cancel(requestParameters: OutboundTransfersApiCancelRequest, options?: AxiosRequestConfig): AxiosPromise<OutboundTransfer> {
         ...
         * @throws {RequiredError}
         */
        create(requestParameters: OutboundTransfersApiCreateRequest, options?: AxiosRequestConfig): AxiosPromise<OutboundTransfer> {
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: OutboundTransfersApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<OutboundTransfer> {
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: OutboundTransfersApiListRequest = {}, options?: AxiosRequestConfig): AxiosPromise<OutboundTransfersListResponse> {
...
/**
 * Request parameters for cancel operation in OutboundTransfersApi.
 * @export
 * @interface OutboundTransfersApiCancelRequest
 */
export type OutboundTransfersApiCancelRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof OutboundTransfersApiCancel
    */
    readonly id: string
...
/**
 * Request parameters for create operation in OutboundTransfersApi.
 * @export
 * @interface OutboundTransfersApiCreateRequest
 */
export type OutboundTransfersApiCreateRequest = {
    
} & OutboundTransferCreateParams

/**
 * Request parameters for get operation in OutboundTransfersApi.
 * @export
 * @interface OutboundTransfersApiGetRequest
 */
export type OutboundTransfersApiGetRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof OutboundTransfersApiGet
    */
    readonly id: string
...
/**
 * Request parameters for list operation in OutboundTransfersApi.
 * @export
 * @interface OutboundTransfersApiListRequest
 */
export type OutboundTransfersApiListRequest = {
    ...
    * @memberof OutboundTransfersApiList
    */
 ...
 * @extends {BaseAPI}
 */
export class OutboundTransfersApi extends OutboundTransfersApiCustom {
    /**
     * An outbound transfer can be canceled only if its status is `pending` and funds have not yet been batched or paid out.  If the cancellation is successful, the OutboundTransfer object is returned.  If the outbound transfer cannot be canceled, an error is returned.
     * @summary Cancel an Outbound Transfer
     * @param {OutboundTransfersApiCancelRequest} requestParameters Request parameters.
     ...
     */
    public cancel(requestParameters: OutboundTransfersApiCancelRequest, options?: AxiosRequestConfig) {
        return OutboundTransfersApiFp(this.configuration).cancel(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OutboundTransfersApi
     */
    public create(requestParameters: OutboundTransfersApiCreateRequest, options?: AxiosRequestConfig) {
        return OutboundTransfersApiFp(this.configuration).create(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OutboundTransfersApi
     */
    public get(requestParameters: OutboundTransfersApiGetRequest, options?: AxiosRequestConfig) {
        return OutboundTransfersApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OutboundTransfersApi
     */
    public list(requestParameters: OutboundTransfersApiListRequest = {}, options?: AxiosRequestConfig) {
        return OutboundTransfersApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
