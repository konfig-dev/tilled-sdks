...
// @ts-ignore
import { AuthLinkCreateParams } from '../models';
// @ts-ignore
import { AuthLinkDto } from '../models';
import { paginate } from "../pagination/paginate";
import { requestBeforeHook } from '../requestBeforeHook';
import { AuthLinksApiCustom } from "./auth-links-api-custom";
/**
...
export const AuthLinksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        create: async (authLinkCreateParams: AuthLinkCreateParams, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'authLinkCreateParams' is not null or undefined
            assertParamExists('create', 'authLinkCreateParams', authLinkCreateParams)
            ...
            requestBeforeHook({
                requestBody: authLinkCreateParams,
...
export const AuthLinksApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Create an auth link for a user.
         * @summary Create an Auth Link
         * @param {AuthLinksApiCreateRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async create(requestParameters: AuthLinksApiCreateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthLinkDto>> {
...
export const AuthLinksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        create(requestParameters: AuthLinksApiCreateRequest, options?: AxiosRequestConfig): AxiosPromise<AuthLinkDto> {
...
/**
 * Request parameters for create operation in AuthLinksApi.
 * @export
 * @interface AuthLinksApiCreateRequest
 */
export type AuthLinksApiCreateRequest = {
 ...
 * @extends {BaseAPI}
 */
export class AuthLinksApi extends AuthLinksApiCustom {
    /**
     * Create an auth link for a user.
     * @summary Create an Auth Link
     * @param {AuthLinksApiCreateRequest} requestParameters Request parameters.
     ...
     */
    public create(requestParameters: AuthLinksApiCreateRequest, options?: AxiosRequestConfig) {
        return AuthLinksApiFp(this.configuration).create(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
