...
// @ts-ignore
import { DisputeEvidenceCreateParams } from '../models';
// @ts-ignore
import { DisputeFileCreateParams } from '../models';
// @ts-ignore
import { DisputesListResponse } from '../models';
import { paginate } from "../pagination/paginate";
import { requestBeforeHook } from '../requestBeforeHook';
import { DisputesApiCustom } from "./disputes-api-custom";
/**
...
export const DisputesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createEvidence: async (id: string, disputeEvidenceCreateParams: DisputeEvidenceCreateParams, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('createEvidence', 'id', id)
            // verify required parameter 'disputeEvidenceCreateParams' is not null or undefined
            assertParamExists('createEvidence', 'disputeEvidenceCreateParams', disputeEvidenceCreateParams)
            ...
            requestBeforeHook({
                requestBody: disputeEvidenceCreateParams,
         ...
         * @param {string} [chargeId] Only returns disputes for the charge specified by this charge ID.
         ...
         * @throws {RequiredError}
         */
        list: async (chargeId?: string, includeConnectedAccounts?: boolean, createdAtGte?: string, createdAtLte?: string, status?: Array<'warning_needs_response' | 'warning_under_review' | 'warning_closed' | 'needs_response' | 'under_review' | 'closed' | 'won' | 'lost'>, offset?: number, limit?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const DisputesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Provide evidence to challenge a dispute.
         * @summary Create Dispute Evidence
         * @param {DisputesApiCreateEvidenceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createEvidence(requestParameters: DisputesApiCreateEvidenceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Dispute>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createEvidence(requestParameters.id, requestParameters, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieves the details of an existing dispute with the given ID.
         * @summary Get a Dispute
         * @param {DisputesApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: DisputesApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Dispute>> {
         ...
         * Returns a list of existing disputes. The disputes are returned in sorted order, with the most recent disputes appearing first.
         * @summary List all Disputes
         * @param {DisputesApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: DisputesApiListRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DisputesListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(requestParameters.chargeId, requestParameters.includeConnectedAccounts, requestParameters.createdAtGte, requestParameters.createdAtLte, requestParameters.status, requestParameters.offset, requestParameters.limit, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const DisputesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createEvidence(requestParameters: DisputesApiCreateEvidenceRequest, options?: AxiosRequestConfig): AxiosPromise<Dispute> {
            return localVarFp.createEvidence(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves the details of an existing dispute with the given ID.
         * @summary Get a Dispute
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: DisputesApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<Dispute> {
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: DisputesApiListRequest = {}, options?: AxiosRequestConfig): AxiosPromise<DisputesListResponse> {
...
/**
 * Request parameters for createEvidence operation in DisputesApi.
 * @export
 * @interface DisputesApiCreateEvidenceRequest
 */
export type DisputesApiCreateEvidenceRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof DisputesApiCreateEvidence
    */
    readonly id: string
...
/**
 * Request parameters for get operation in DisputesApi.
 * @export
 * @interface DisputesApiGetRequest
 */
export type DisputesApiGetRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof DisputesApiGet
    */
    readonly id: string
...
/**
 * Request parameters for list operation in DisputesApi.
 * @export
 * @interface DisputesApiListRequest
 */
export type DisputesApiListRequest = {
    
    /**
    * Only returns disputes for the charge specified by this charge ID.
    * @type {string}
    * @memberof DisputesApiList
    */
 ...
 * @extends {BaseAPI}
 */
export class DisputesApi extends DisputesApiCustom {
    /**
     * Provide evidence to challenge a dispute.
     * @summary Create Dispute Evidence
     * @param {DisputesApiCreateEvidenceRequest} requestParameters Request parameters.
     ...
     */
    public createEvidence(requestParameters: DisputesApiCreateEvidenceRequest, options?: AxiosRequestConfig) {
        return DisputesApiFp(this.configuration).createEvidence(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DisputesApi
     */
    public get(requestParameters: DisputesApiGetRequest, options?: AxiosRequestConfig) {
        return DisputesApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DisputesApi
     */
    public list(requestParameters: DisputesApiListRequest = {}, options?: AxiosRequestConfig) {
        return DisputesApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
