...
// @ts-ignore
import { MerchantApplication } from '../models';
// @ts-ignore
import { MerchantApplicationBusinessLegalEntity } from '../models';
// @ts-ignore
import { MerchantApplicationCreateParams } from '../models';
import { paginate } from "../pagination/paginate";
import { requestBeforeHook } from '../requestBeforeHook';
import { OnboardingApiCustom } from "./onboarding-api-custom";
/**
...
export const OnboardingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getMerchanApplication: async (accountId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
            assertParamExists('getMerchanApplication', 'accountId', accountId)
         ...
         * @throws {RequiredError}
         */
        submitMerchantApplication: async (accountId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
            assertParamExists('submitMerchantApplication', 'accountId', accountId)
         ...
         * @throws {RequiredError}
         */
        updateMerchantApplication: async (accountId: string, merchantApplicationCreateParams: MerchantApplicationCreateParams, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
            assertParamExists('updateMerchantApplication', 'accountId', accountId)
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: merchantApplicationCreateParams,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration
...
export const OnboardingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Retrieves a merchant application as long as its `status` is `created` or `started`. Once the application is `submitted` or `active` it is not accessible.
         * @summary Get a Merchant Application
         * @param {OnboardingApiGetMerchanApplicationRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getMerchanApplication(requestParameters: OnboardingApiGetMerchanApplicationRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MerchantApplication>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMerchanApplication(requestParameters.accountId, options);
         ...
         * @throws {RequiredError}
         */
        async submitMerchantApplication(requestParameters: OnboardingApiSubmitMerchantApplicationRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.submitMerchantApplication(requestParameters.accountId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Updates a merchant application by overwriting all properties.
         ...
         * @throws {RequiredError}
         */
        async updateMerchantApplication(requestParameters: OnboardingApiUpdateMerchantApplicationRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MerchantApplication>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateMerchantApplication(requestParameters.accountId, requestParameters, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const OnboardingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getMerchanApplication(requestParameters: OnboardingApiGetMerchanApplicationRequest, options?: AxiosRequestConfig): AxiosPromise<MerchantApplication> {
            return localVarFp.getMerchanApplication(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Submits a merchant application to be processed. If any validation errors exist, you must correct them before re-submitting. Once successful submission, you cannot access the application again.
         * @summary Submit a Merchant Application
        ...
        submitMerchantApplication(requestParameters: OnboardingApiSubmitMerchantApplicationRequest, options?: AxiosRequestConfig): AxiosPromise<object> {
            return localVarFp.submitMerchantApplication(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates a merchant application by overwriting all properties.
         * @summary Update a Merchant Application
        ...
        updateMerchantApplication(requestParameters: OnboardingApiUpdateMerchantApplicationRequest, options?: AxiosRequestConfig): AxiosPromise<MerchantApplication> {
            return localVarFp.updateMerchantApplication(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getMerchanApplication operation in OnboardingApi.
 * @export
 * @interface OnboardingApiGetMerchanApplicationRequest
 */
export type OnboardingApiGetMerchanApplicationRequest = {
    
    /**
    * The id of the associated connected (i.e. merchant) account.
    * @type {string}
    * @memberof OnboardingApiGetMerchanApplication
    */
 ...
 */
export type OnboardingApiSubmitMerchantApplicationRequest = {
 ...
 */
export type OnboardingApiUpdateMerchantApplicationRequest = {
 ...
 * @extends {BaseAPI}
 */
export class OnboardingApi extends OnboardingApiCustom {
    /**
     * Retrieves a merchant application as long as its `status` is `created` or `started`. Once the application is `submitted` or `active` it is not accessible.
     * @summary Get a Merchant Application
     * @param {OnboardingApiGetMerchanApplicationRequest} requestParameters Request parameters.
     ...
     */
    public getMerchanApplication(requestParameters: OnboardingApiGetMerchanApplicationRequest, options?: AxiosRequestConfig) {
        return OnboardingApiFp(this.configuration).getMerchanApplication(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public submitMerchantApplication(requestParameters: OnboardingApiSubmitMerchantApplicationRequest, options?: AxiosRequestConfig) {
        return OnboardingApiFp(this.configuration).submitMerchantApplication(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateMerchantApplication(requestParameters: OnboardingApiUpdateMerchantApplicationRequest, options?: AxiosRequestConfig) {
        return OnboardingApiFp(this.configuration).updateMerchantApplication(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
