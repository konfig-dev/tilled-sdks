...
// @ts-ignore
import { PlatformFeeRefund } from '../models';
import { paginate } from "../pagination/paginate";
import { requestBeforeHook } from '../requestBeforeHook';
import { PlatformFeeRefundsApiCustom } from "./platform-fee-refunds-api-custom";
/**
...
export const PlatformFeeRefundsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        get: async (id: string, refundId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('get', 'id', id)
            // verify required parameter 'refundId' is not null or undefined
            assertParamExists('get', 'refundId', refundId)
...
export const PlatformFeeRefundsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Retrieves the details of a specific refund stored on the platform fee.
         * @summary Get a Platform Fee Refund
         * @param {PlatformFeeRefundsApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: PlatformFeeRefundsApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlatformFeeRefund>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.get(requestParameters.id, requestParameters.refundId, options);
...
export const PlatformFeeRefundsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: PlatformFeeRefundsApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<PlatformFeeRefund> {
...
/**
 * Request parameters for get operation in PlatformFeeRefundsApi.
 * @export
 * @interface PlatformFeeRefundsApiGetRequest
 */
export type PlatformFeeRefundsApiGetRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof PlatformFeeRefundsApiGet
    */
    readonly id: string
 ...
 * @extends {BaseAPI}
 */
export class PlatformFeeRefundsApi extends PlatformFeeRefundsApiCustom {
    /**
     * Retrieves the details of a specific refund stored on the platform fee.
     * @summary Get a Platform Fee Refund
     * @param {PlatformFeeRefundsApiGetRequest} requestParameters Request parameters.
     ...
     */
    public get(requestParameters: PlatformFeeRefundsApiGetRequest, options?: AxiosRequestConfig) {
        return PlatformFeeRefundsApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
