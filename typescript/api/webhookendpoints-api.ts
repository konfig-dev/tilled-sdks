...
// @ts-ignore
import { WebhookEndpointCreateParams } from '../models';
// @ts-ignore
import { WebhookEndpointUpdateParams } from '../models';
// @ts-ignore
import { WebhookEndpointsListResponse } from '../models';
import { paginate } from "../pagination/paginate";
import { requestBeforeHook } from '../requestBeforeHook';
import { WebhookendpointsApiCustom } from "./webhookendpoints-api-custom";
/**
...
export const WebhookendpointsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        create: async (webhookEndpointCreateParams: WebhookEndpointCreateParams, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'webhookEndpointCreateParams' is not null or undefined
            assertParamExists('create', 'webhookEndpointCreateParams', webhookEndpointCreateParams)
            ...
            requestBeforeHook({
                requestBody: webhookEndpointCreateParams,
         ...
         * @throws {RequiredError}
         */
        update: async (id: string, webhookEndpointUpdateParams: WebhookEndpointUpdateParams, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('update', 'id', id)
            // verify required parameter 'webhookEndpointUpdateParams' is not null or undefined
            assertParamExists('update', 'webhookEndpointUpdateParams', webhookEndpointUpdateParams)
            const localVarPath = `/v1/webhook-endpoints/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: webhookEndpointUpdateParams,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration
...
export const WebhookendpointsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * A webhook endpoint must have a url and a list of enabled_events. The specified url will be notified about events from all connected accounts along with your account.
         * @summary Create a Webhook Endpoint
         * @param {WebhookendpointsApiCreateRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async create(requestParameters: WebhookendpointsApiCreateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhookEndpoint>> {
         ...
         * Delete a webhook endpoint.
         * @summary Delete a Webhook Endpoint
         * @param {WebhookendpointsApiDeleteRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async delete(requestParameters: WebhookendpointsApiDeleteRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
         ...
         * Retrieves the webhook endpoint with the given ID.
         * @summary Get a Webhook Endpoint
         * @param {WebhookendpointsApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: WebhookendpointsApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhookEndpoint>> {
         ...
         * @throws {RequiredError}
         */
        async list(requestParameters: WebhookendpointsApiListRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhookEndpointsListResponse>> {
         ...
         * Updates the webhook endpoint. Any parameters not provided will be left unchanged.
         * @summary Update a Webhook Endpoint
         * @param {WebhookendpointsApiUpdateRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async update(requestParameters: WebhookendpointsApiUpdateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhookEndpoint>> {
...
export const WebhookendpointsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        create(requestParameters: WebhookendpointsApiCreateRequest, options?: AxiosRequestConfig): AxiosPromise<WebhookEndpoint> {
         ...
         * @throws {RequiredError}
         */
        delete(requestParameters: WebhookendpointsApiDeleteRequest, options?: AxiosRequestConfig): AxiosPromise<object> {
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: WebhookendpointsApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<WebhookEndpoint> {
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: WebhookendpointsApiListRequest = {}, options?: AxiosRequestConfig): AxiosPromise<WebhookEndpointsListResponse> {
         ...
         * @throws {RequiredError}
         */
        update(requestParameters: WebhookendpointsApiUpdateRequest, options?: AxiosRequestConfig): AxiosPromise<WebhookEndpoint> {
...
/**
 * Request parameters for create operation in WebhookendpointsApi.
 * @export
 * @interface WebhookendpointsApiCreateRequest
 */
export type WebhookendpointsApiCreateRequest = {
    
} & WebhookEndpointCreateParams

/**
 * Request parameters for delete operation in WebhookendpointsApi.
 * @export
 * @interface WebhookendpointsApiDeleteRequest
 */
export type WebhookendpointsApiDeleteRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof WebhookendpointsApiDelete
    */
    readonly id: string
...
/**
 * Request parameters for get operation in WebhookendpointsApi.
 * @export
 * @interface WebhookendpointsApiGetRequest
 */
export type WebhookendpointsApiGetRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof WebhookendpointsApiGet
    */
    readonly id: string
 ...
 */
export type WebhookendpointsApiListRequest = {
...
/**
 * Request parameters for update operation in WebhookendpointsApi.
 * @export
 * @interface WebhookendpointsApiUpdateRequest
 */
export type WebhookendpointsApiUpdateRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof WebhookendpointsApiUpdate
    */
    readonly id: string
 ...
 * @extends {BaseAPI}
 */
export class WebhookendpointsApi extends WebhookendpointsApiCustom {
    /**
     * A webhook endpoint must have a url and a list of enabled_events. The specified url will be notified about events from all connected accounts along with your account.
     * @summary Create a Webhook Endpoint
     * @param {WebhookendpointsApiCreateRequest} requestParameters Request parameters.
     ...
     */
    public create(requestParameters: WebhookendpointsApiCreateRequest, options?: AxiosRequestConfig) {
        return WebhookendpointsApiFp(this.configuration).create(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebhookendpointsApi
     */
    public delete(requestParameters: WebhookendpointsApiDeleteRequest, options?: AxiosRequestConfig) {
        return WebhookendpointsApiFp(this.configuration).delete(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebhookendpointsApi
     */
    public get(requestParameters: WebhookendpointsApiGetRequest, options?: AxiosRequestConfig) {
        return WebhookendpointsApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebhookendpointsApi
     */
    public update(requestParameters: WebhookendpointsApiUpdateRequest, options?: AxiosRequestConfig) {
        return WebhookendpointsApiFp(this.configuration).update(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
