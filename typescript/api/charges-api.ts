...
import { ChargesApiCustom } from "./charges-api-custom";
/**
...
export const ChargesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Retrieves a Charge object.
         * @summary Get a Charge
         * @param {ChargesApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: ChargesApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Charge>> {
...
export const ChargesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: ChargesApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<Charge> {
...
/**
 * Request parameters for get operation in ChargesApi.
 * @export
 * @interface ChargesApiGetRequest
 */
export type ChargesApiGetRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ChargesApiGet
    */
    readonly id: string
 ...
 * @extends {BaseAPI}
 */
export class ChargesApi extends ChargesApiCustom {
    /**
     * Retrieves a Charge object.
     * @summary Get a Charge
     * @param {ChargesApiGetRequest} requestParameters Request parameters.
     ...
     * @memberof ChargesApi
     */
    public get(requestParameters: ChargesApiGetRequest, options?: AxiosRequestConfig) {
        return ChargesApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
