...
// @ts-ignore
import { ProductCodesListResponse } from '../models';
import { paginate } from "../pagination/paginate";
import { requestBeforeHook } from '../requestBeforeHook';
import { ProductcodesApiCustom } from "./productcodes-api-custom";
/**
...
export const ProductcodesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * *Deprecated: Use Pricing Templates to configure merchant accounts during onboarding.*  Returns a list of ProductCodes available to a given `partner` account. These are the product codes that are available to be assigned to `merchant` accounts during merchant onboarding.
...
export const ProductcodesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * *Deprecated: Use Pricing Templates to configure merchant accounts during onboarding.*  Returns a list of ProductCodes available to a given `partner` account. These are the product codes that are available to be assigned to `merchant` accounts during merchant onboarding.
         * @summary List an Account\'s Product Codes
         * @param {ProductcodesApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @deprecated
         * @throws {RequiredError}
         */
        async list(requestParameters: ProductcodesApiListRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductCodesListResponse>> {
...
export const ProductcodesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: ProductcodesApiListRequest = {}, options?: AxiosRequestConfig): AxiosPromise<ProductCodesListResponse> {
...
/**
 * Request parameters for list operation in ProductcodesApi.
 * @export
 * @interface ProductcodesApiListRequest
 */
export type ProductcodesApiListRequest = {
    
    /**
    * The (zero-based) offset of the first item in the collection to return.
    * @type {number}
    * @memberof ProductcodesApiList
    */
 ...
 * @extends {BaseAPI}
 */
export class ProductcodesApi extends ProductcodesApiCustom {
    /**
     * *Deprecated: Use Pricing Templates to configure merchant accounts during onboarding.*  Returns a list of ProductCodes available to a given `partner` account. These are the product codes that are available to be assigned to `merchant` accounts during merchant onboarding.
     * @summary List an Account\'s Product Codes
     * @param {ProductcodesApiListRequest} requestParameters Request parameters.
     ...
     */
    public list(requestParameters: ProductcodesApiListRequest = {}, options?: AxiosRequestConfig) {
        return ProductcodesApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
