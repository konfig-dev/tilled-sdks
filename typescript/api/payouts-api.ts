...
// @ts-ignore
import { PayoutsListResponse } from '../models';
import { paginate } from "../pagination/paginate";
import { requestBeforeHook } from '../requestBeforeHook';
import { PayoutsApiCustom } from "./payouts-api-custom";
/**
...
export const PayoutsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        get: async (id: string, include?: Array<'transaction_count'>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        list: async (createdAtGte?: string, createdAtLte?: string, paidAtGte?: string, paidAtLte?: string, status?: 'canceled' | 'failed' | 'in_transit' | 'paid' | 'pending', include?: 'transaction_count', includeConnectedAccounts?: boolean, offset?: number, limit?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const PayoutsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Retrieves the details of an existing payout with the given ID.
         * @summary Get a Payout
         * @param {PayoutsApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: PayoutsApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Payout>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.get(requestParameters.id, requestParameters.include, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns a list of existing payouts. The payouts are returned in sorted order, with the most recent payouts appearing first.
         * @summary List all Payouts
         * @param {PayoutsApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: PayoutsApiListRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PayoutsListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(requestParameters.createdAtGte, requestParameters.createdAtLte, requestParameters.paidAtGte, requestParameters.paidAtLte, requestParameters.status, requestParameters.include, requestParameters.includeConnectedAccounts, requestParameters.offset, requestParameters.limit, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const PayoutsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: PayoutsApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<Payout> {
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: PayoutsApiListRequest = {}, options?: AxiosRequestConfig): AxiosPromise<PayoutsListResponse> {
...
/**
 * Request parameters for get operation in PayoutsApi.
 * @export
 * @interface PayoutsApiGetRequest
 */
export type PayoutsApiGetRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof PayoutsApiGet
    */
    readonly id: string
...
/**
 * Request parameters for list operation in PayoutsApi.
 * @export
 * @interface PayoutsApiListRequest
 */
export type PayoutsApiListRequest = {
    
    /**
    * Minimum `created_at` value to filter by (inclusive). Cannot be paired with paid_at_gte or paid_at_lte.
    * @type {string}
    * @memberof PayoutsApiList
    */
 ...
 * @extends {BaseAPI}
 */
export class PayoutsApi extends PayoutsApiCustom {
    /**
     * Retrieves the details of an existing payout with the given ID.
     * @summary Get a Payout
     * @param {PayoutsApiGetRequest} requestParameters Request parameters.
     ...
     * @memberof PayoutsApi
     */
    public get(requestParameters: PayoutsApiGetRequest, options?: AxiosRequestConfig) {
        return PayoutsApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PayoutsApi
     */
    public list(requestParameters: PayoutsApiListRequest = {}, options?: AxiosRequestConfig) {
        return PayoutsApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
