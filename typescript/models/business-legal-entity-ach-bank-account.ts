...
// @ts-ignore
import { BLEBankAccount } from './blebank-account';
...
export interface BusinessLegalEntityAchBankAccount {
     ...
     * @memberof BusinessLegalEntityAchBankAccount
     */
    'type'?: BusinessLegalEntityAchBankAccountTypeEnum;
}

type BusinessLegalEntityAchBankAccountTypeEnum = 'checking' | 'savings'
