...
export interface PayoutBalanceTransaction {
     ...
     * @memberof PayoutBalanceTransaction
     */
    'fee_subtype'?: PayoutBalanceTransactionFeeSubtypeEnum;
    /**
     * Fee type, if this transaction represents a fee (i.e. type = fee).
     * @type {string}
     * @memberof PayoutBalanceTransaction
     */
    'fee_type'?: PayoutBalanceTransactionFeeTypeEnum;
    /**
     ...
     * @memberof PayoutBalanceTransaction
     */
    'source_type': PayoutBalanceTransactionSourceTypeEnum;
    /**
