...
export interface CheckoutSession {
     ...
     * @memberof CheckoutSession
     */
    'currency': CheckoutSessionCurrencyEnum;
    /**
     * 
     ...
     * @memberof CheckoutSession
     */
    'payment_method_types': Array<CheckoutSessionPaymentMethodTypesEnum>;
    /**
...
type CheckoutSessionCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type CheckoutSessionPaymentMethodTypesEnum = 'card' | 'ach_debit' | 'eft_debit'
