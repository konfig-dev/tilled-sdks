...
type AccountCapabilityProductCodeCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type AccountCapabilityProductCodePaymentMethodTypeEnum = 'card' | 'ach_debit' | 'card_present' | 'eft_debit'
type AccountCapabilityProductCodeRegionEnum = 'US' | 'CA'
