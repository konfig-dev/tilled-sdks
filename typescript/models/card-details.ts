...
export interface CardDetails {
     ...
     * @memberof CardDetails
     */
    'funding'?: CardDetailsFundingEnum;
    /**
...
type CardDetailsBrandEnum = 'amex' | 'diners' | 'discover' | 'jcb' | 'maestro' | 'mastercard' | 'solo' | 'visa' | 'visa_debit' | 'visa_electron' | 'unknown'
type CardDetailsFundingEnum = 'credit' | 'debit' | 'prepaid' | 'unknown'
