...
type BalanceTransactionFeeDetailCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type BalanceTransactionFeeDetailTypeEnum = 'platform_fee' | 'tilled_fee' | 'tax' | 'chargeback_fee'
