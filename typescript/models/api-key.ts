...
type ApiKeyScopesEnum = '*' | 'accounts:read' | 'accounts:write' | 'accounts:delete' | 'api_keys:read' | 'api_keys:write' | 'auth_links:read' | 'auth_links:write' | 'balance_transactions:read' | 'charges:read' | 'customers:read' | 'customers:write' | 'events:read' | 'payment_intents:read' | 'payment_intents:write' | 'payment_methods:read' | 'payment_methods:write' | 'payouts:read' | 'payouts:write' | 'platform_fees:read' | 'product_codes:read' | 'refunds:read' | 'refunds:write' | 'users:read' | 'users:write' | 'webhook_endpoints:read' | 'webhook_endpoints:write' | 'apple_pay_domains:read' | 'apple_pay_domains:write' | 'bank_accounts:read' | 'bank_accounts:write' | 'files:read' | 'files:write' | 'user_invitations:read' | 'user_invitations:write' | 'subscriptions:read' | 'subscriptions:write' | 'disputes:read' | 'disputes:write' | 'pricing_templates:read' | 'pricing_templates:write' | 'checkout_sessions:read' | 'checkout_sessions:write' | 'outbound_transfers:read' | 'outbound_transfers:write'
type ApiKeyTypeEnum = 'publishable' | 'secret'
