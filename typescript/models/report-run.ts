...
type ReportRunStatusEnum = 'queued' | 'finished' | 'failed'
type ReportRunTypeEnum = 'payments_summary_1' | 'payouts_summary_1' | 'payouts_summary_2' | 'fees_summary_1' | 'processing_summary_1' | 'disputes_summary_1'
