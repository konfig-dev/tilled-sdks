...
export interface OutboundTransfer {
     ...
     * @memberof OutboundTransfer
     */
    'currency': OutboundTransferCurrencyEnum;
    /**
     ...
     * @memberof OutboundTransfer
     */
    'failure_code'?: OutboundTransferFailureCodeEnum;
    /**
     ...
     * @memberof OutboundTransfer
     */
    'status': OutboundTransferStatusEnum;
    /**
...
type OutboundTransferCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type OutboundTransferFailureCodeEnum = 'account_closed' | 'account_frozen' | 'account_number_invalid' | 'authorization_revoked' | 'bank_account_blocked' | 'fraudulent' | 'insufficient_funds' | 'invalid_field' | 'limit_exceeded' | 'no_account' | 'not_authorized' | 'not_permitted' | 'processing_error' | 'not_recognized' | 'risk_blocked' | 'stop_payment'
type OutboundTransferStatusEnum = 'canceled' | 'failed' | 'pending' | 'succeeded'
