...
type PrincipalNationalityEnum = 'AF' | 'AL' | 'DZ' | 'US' | 'AS' | 'AD' | 'AO' | 'AI' | 'AQ' | 'AG' | 'AR' | 'AM' | 'AW' | 'AU' | 'AT' | 'AZ' | 'BS' | 'BH' | 'BD' | 'BB' | 'BL' | 'BY' | 'BE' | 'BZ' | 'BJ' | 'BM' | 'BT' | 'BO' | 'BA' | 'BR' | 'GB' | 'BN' | 'BG' | 'BF' | 'BI' | 'KH' | 'CM' | 'CA' | 'CV' | 'KY' | 'CF' | 'TD' | 'CL' | 'CN' | 'CX' | 'CC' | 'CO' | 'KM' | 'CG' | 'CD' | 'CK' | 'CR' | 'HR' | 'CU' | 'CW' | 'CY' | 'CZ' | 'DK' | 'DJ' | 'DM' | 'DO' | 'NL' | 'EC' | 'EG' | 'AE' | 'GQ' | 'ER' | 'EE' | 'ET' | 'FK' | 'FO' | 'FJ' | 'PH' | 'FI' | 'FR' | 'GF' | 'PF' | 'GA' | 'GM' | 'GE' | 'DE' | 'GH' | 'GI' | 'GR' | 'GL' | 'GD' | 'GP' | 'GU' | 'GT' | 'GW' | 'GN' | 'GY' | 'HT' | 'HN' | 'HK' | 'HU' | 'KI' | 'IS' | 'IN' | 'ID' | 'IR' | 'IQ' | 'IE' | 'IL' | 'IT' | 'CI' | 'JM' | 'JP' | 'JO' | 'KZ' | 'KE' | 'KN' | 'KW' | 'KG' | 'LA' | 'LV' | 'LB' | 'LR' | 'LY' | 'LI' | 'LT' | 'LU' | 'MO' | 'MK' | 'YT' | 'MG' | 'MW' | 'MY' | 'MV' | 'ML' | 'MT' | 'IM' | 'MH' | 'MQ' | 'MR' | 'MU' | 'MX' | 'FM' | 'MD' | 'MC' | 'MN' | 'ME' | 'MS' | 'MA' | 'LS' | 'BW' | 'MZ' | 'MM' | 'NA' | 'NR' | 'NP' | 'NC' | 'NZ' | 'VU' | 'NI' | 'NG' | 'NE' | 'NU' | 'NF' | 'KP' | 'MP' | 'false' | 'OM' | 'PK' | 'PW' | 'PS' | 'PA' | 'PG' | 'PY' | 'PE' | 'PN' | 'PL' | 'PT' | 'PR' | 'QA' | 'RO' | 'RU' | 'RW' | 'SH' | 'LC' | 'VC' | 'PM' | 'SV' | 'WS' | 'SM' | 'SA' | 'SN' | 'RS' | 'SC' | 'SL' | 'SG' | 'SK' | 'SI' | 'SB' | 'SO' | 'ZA' | 'KR' | 'ES' | 'LK' | 'SD' | 'SS' | 'SR' | 'SZ' | 'SE' | 'CH' | 'SY' | 'ST' | 'TW' | 'TJ' | 'TZ' | 'TH' | 'TL' | 'TG' | 'TK' | 'TO' | 'TT' | 'TN' | 'TR' | 'TM' | 'TC' | 'TV' | 'UG' | 'UA' | 'UY' | 'UZ' | 'VE' | 'VN' | 'VG' | 'WF' | 'EH' | 'YE' | 'ZM' | 'ZW' | 'AX'
type PrincipalTypeEnum = 'director' | 'shareholder' | 'merchant_rep' | 'contact'
