 ...
 * The file.
 * @export
 * @interface DisputeFileFile
 */
export interface DisputeFileFile {
    /**
     * The user friendly title.
     * @type {string}
     * @memberof DisputeFileFile
     */
    'title'?: string;
    /**
     ...
     * @memberof DisputeFileFile
     */
    'purpose': DisputeFileFilePurposeEnum;
    /**
     * The file size.
     * @type {number}
     * @memberof DisputeFileFile
...
type DisputeFileFilePurposeEnum = 'logo' | 'icon' | 'terms' | 'report' | 'dispute_evidence' | 'onboarding_documentation'
type DisputeFileFileTypeEnum = 'png' | 'jpg' | 'pdf' | 'csv' | 'tiff'
