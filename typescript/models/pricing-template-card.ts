...
// @ts-ignore
import { CardChargeFeeTemplate } from './card-charge-fee-template';
// May contain unused imports in some cases
// @ts-ignore
 ...
 * @export
 * @interface PricingTemplateCard
 */
export interface PricingTemplateCard {
    /**
     * The amount of the fee applied per chargeback, in currency minor units.
     * @type {number}
     * @memberof PricingTemplateCard
     */
     ...
     * @memberof PricingTemplateCard
     */
    'transaction_fee_type': PricingTemplateCardTransactionFeeTypeEnum;
}

type PricingTemplateCardTransactionFeeTypeEnum = 'flat_rate' | 'interchange'
