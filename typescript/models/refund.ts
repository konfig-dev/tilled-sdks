...
type RefundFailureCodeEnum = 'expired_or_canceled_card' | 'lost_or_stolen_card' | 'fraudulent' | 'risk_blocked' | 'declined' | 'proprietary_card_activity_regulations' | 'blacklisted_card' | 'not_permitted' | 'processing_error'
type RefundReasonEnum = 'duplicate' | 'fraudulent' | 'requested_by_customer' | 'expired_uncaptured_charge' | 'partial_capture'
type RefundStatusEnum = 'canceled' | 'pending' | 'succeeded' | 'failed'
