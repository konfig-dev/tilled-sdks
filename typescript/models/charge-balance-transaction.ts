...
export interface ChargeBalanceTransaction {
     ...
     * @memberof ChargeBalanceTransaction
     */
    'fee_subtype'?: ChargeBalanceTransactionFeeSubtypeEnum;
    /**
     * Fee type, if this transaction represents a fee (i.e. type = fee).
     * @type {string}
     * @memberof ChargeBalanceTransaction
     */
    'fee_type'?: ChargeBalanceTransactionFeeTypeEnum;
    /**
     ...
     * @memberof ChargeBalanceTransaction
     */
    'source_type': ChargeBalanceTransactionSourceTypeEnum;
    /**
