...
type PaymentIntentUpdateParamsCaptureMethodEnum = 'automatic' | 'manual'
type PaymentIntentUpdateParamsCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type PaymentIntentUpdateParamsOccurrenceTypeEnum = 'consumer_ad_hoc' | 'merchant_ad_hoc' | 'merchant_recurring'
type PaymentIntentUpdateParamsPaymentMethodTypesEnum = 'card' | 'ach_debit' | 'eft_debit'
