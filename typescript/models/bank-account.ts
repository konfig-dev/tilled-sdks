...
type BankAccountCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type BankAccountStatusEnum = 'new' | 'validated' | 'verified' | 'verification_failed' | 'errored'
type BankAccountTypeEnum = 'checking' | 'savings'
