...
type PaymentIntentCreateParamsCaptureMethodEnum = 'automatic' | 'manual'
type PaymentIntentCreateParamsCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type PaymentIntentCreateParamsOccurrenceTypeEnum = 'consumer_ad_hoc' | 'merchant_ad_hoc' | 'merchant_recurring'
type PaymentIntentCreateParamsPaymentMethodTypesEnum = 'card' | 'ach_debit' | 'eft_debit'
