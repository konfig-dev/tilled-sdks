...
type ChargeFailureCodeEnum = 'account_closed' | 'account_frozen' | 'account_number_invalid' | 'authorization_revoked' | 'avs_check_failed' | 'bank_account_blocked' | 'call_issuer' | 'card_not_supported' | 'expired_card' | 'fraudulent' | 'generic_decline' | 'incorrect_cvc' | 'insufficient_funds' | 'invalid_expiry' | 'invalid_field' | 'invalid_number' | 'limit_exceeded' | 'no_account' | 'not_authorized' | 'not_permitted' | 'processing_error' | 'not_recognized' | 'pickup_card' | 'restricted_card' | 'risk_blocked' | 'service_not_allowed' | 'stop_payment' | 'internal_error'
type ChargeStatusEnum = 'succeeded' | 'pending' | 'failed'
