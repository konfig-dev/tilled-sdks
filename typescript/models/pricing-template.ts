...
export interface PricingTemplate {
     ...
     * @memberof PricingTemplate
     */
    'currency': PricingTemplateCurrencyEnum;
    /**
     * 
     ...
     * @memberof PricingTemplate
     */
    'payment_method_type': PricingTemplatePaymentMethodTypeEnum;
    /**
     * The status of this pricing template
     * @type {string}
     * @memberof PricingTemplate
     */
    'status': PricingTemplateStatusEnum;
    /**
...
type PricingTemplateCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type PricingTemplatePaymentMethodTypeEnum = 'card' | 'ach_debit' | 'eft_debit'
type PricingTemplateStatusEnum = 'active' | 'archived' | 'pending'
