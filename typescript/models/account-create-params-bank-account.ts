...
// @ts-ignore
import { BankAccountCreateParams } from './bank-account-create-params';
...
type AccountCreateParamsBankAccountCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type AccountCreateParamsBankAccountTypeEnum = 'checking' | 'savings'
