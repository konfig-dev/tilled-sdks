...
export interface PlatformFeeRefundBalanceTransaction {
     ...
     * @memberof PlatformFeeRefundBalanceTransaction
     */
    'fee_subtype'?: PlatformFeeRefundBalanceTransactionFeeSubtypeEnum;
    /**
     * Fee type, if this transaction represents a fee (i.e. type = fee).
     * @type {string}
     * @memberof PlatformFeeRefundBalanceTransaction
     */
    'fee_type'?: PlatformFeeRefundBalanceTransactionFeeTypeEnum;
    /**
     ...
     * @memberof PlatformFeeRefundBalanceTransaction
     */
    'source_type': PlatformFeeRefundBalanceTransactionSourceTypeEnum;
    /**
