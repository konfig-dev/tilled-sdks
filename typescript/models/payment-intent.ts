...
type PaymentIntentCancellationReasonEnum = 'duplicate' | 'fraudulent' | 'requested_by_customer' | 'abandoned' | 'automatic'
type PaymentIntentCaptureMethodEnum = 'automatic' | 'manual'
type PaymentIntentCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type PaymentIntentOccurrenceTypeEnum = 'consumer_ad_hoc' | 'merchant_ad_hoc' | 'merchant_recurring'
type PaymentIntentPaymentMethodTypesEnum = 'card' | 'ach_debit' | 'eft_debit'
type PaymentIntentStatusEnum = 'canceled' | 'processing' | 'requires_action' | 'requires_capture' | 'requires_confirmation' | 'requires_payment_method' | 'succeeded'
