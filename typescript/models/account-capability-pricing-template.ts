 ...
 * @export
 * @interface AccountCapabilityPricingTemplate
 */
export interface AccountCapabilityPricingTemplate {
    /**
     * The ID of the Account associated with this pricing template.
     * @type {string}
     * @memberof AccountCapabilityPricingTemplate
     */
    'account_id': string;
    /**
     ...
     * @memberof AccountCapabilityPricingTemplate
     */
    'currency': AccountCapabilityPricingTemplateCurrencyEnum;
    /**
     * 
     ...
     * @memberof AccountCapabilityPricingTemplate
     */
    'payment_method_type': AccountCapabilityPricingTemplatePaymentMethodTypeEnum;
    /**
     * The status of this pricing template
     * @type {string}
     * @memberof AccountCapabilityPricingTemplate
     */
    'status': AccountCapabilityPricingTemplateStatusEnum;
    /**
...
type AccountCapabilityPricingTemplateCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type AccountCapabilityPricingTemplatePaymentMethodTypeEnum = 'card' | 'ach_debit' | 'eft_debit'
type AccountCapabilityPricingTemplateStatusEnum = 'active' | 'archived' | 'pending'
