...
type ProductCodeCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type ProductCodePaymentMethodTypeEnum = 'card' | 'ach_debit' | 'card_present' | 'eft_debit'
type ProductCodeRegionEnum = 'US' | 'CA'
