...
type SubscriptionCreateParamsCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type SubscriptionCreateParamsIntervalUnitEnum = 'week' | 'month' | 'year'
