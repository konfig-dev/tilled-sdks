...
type SubscriptionCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type SubscriptionIntervalUnitEnum = 'week' | 'month' | 'year'
type SubscriptionStatusEnum = 'active' | 'canceled' | 'past_due' | 'paused' | 'pending'
