...
export interface PlatformFeeBalanceTransaction {
     ...
     * @memberof PlatformFeeBalanceTransaction
     */
    'fee_subtype'?: PlatformFeeBalanceTransactionFeeSubtypeEnum;
    /**
     * Fee type, if this transaction represents a fee (i.e. type = fee).
     * @type {string}
     * @memberof PlatformFeeBalanceTransaction
     */
    'fee_type'?: PlatformFeeBalanceTransactionFeeTypeEnum;
    /**
     ...
     * @memberof PlatformFeeBalanceTransaction
     */
    'source_type': PlatformFeeBalanceTransactionSourceTypeEnum;
    /**
...
type PlatformFeeBalanceTransactionCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type PlatformFeeBalanceTransactionFeeSubtypeEnum = 'approved_verification' | 'declined_verification' | 'approved_authorization' | 'declined_authorization' | 'reversed_authorization' | 'completed_credit' | 'declined_credit' | 'completed_settlement' | 'declined_settlement' | 'approved_purchase_return_authorization' | 'declined_purchase_return_authorization' | 'acquirer_processing' | 'amex_card_not_present' | 'amex_dues_and_assessments' | 'amex_international_assessment' | 'discover_assessment' | 'discover_data_usage' | 'dues_and_assessments' | 'fixed_acquirer_network' | 'mastercard_annual_location' | 'mastercard_assessment' | 'mastercard_assessment_1000_plus' | 'mastercard_digital_commerce_development' | 'mastercard_digital_enablement' | 'mastercard_international_assessment' | 'mastercard_processing_integrity' | 'nabu' | 'transaction_integrity' | 'visa_assessment' | 'visa_debit_assessment' | 'visa_international_assessment' | 'visa_misuse_of_authorization' | 'reversal' | 'discount' | 'transaction' | 'account_setup' | 'ach_return' | 'monthly_account' | 'monthly_minimum_processing' | 'retrieval' | 'goods_and_services' | 'harmonized_sales'
type PlatformFeeBalanceTransactionFeeTypeEnum = 'discount' | 'transaction' | 'interchange' | 'pass_through' | 'platform' | 'chargeback' | 'administrative' | 'tax' | 'negative_rounding_adjustment' | 'positive_rounding_adjustment' | 'unknown'
type PlatformFeeBalanceTransactionSourceTypeEnum = 'charge' | 'refund' | 'payout' | 'payment_method' | 'platform_fee' | 'platform_fee_refund' | 'dispute' | 'account' | 'outbound_transfer'
type PlatformFeeBalanceTransactionStatusEnum = 'available' | 'pending'
type PlatformFeeBalanceTransactionTypeEnum = 'charge' | 'charge_failure_refund' | 'dispute' | 'dispute_won' | 'refund' | 'refund_failure' | 'adjustment' | 'commission' | 'payout' | 'payout_cancel' | 'payout_failure' | 'fee' | 'platform_fee' | 'platform_fee_refund' | 'outbound_transfer' | 'outbound_transfer_cancel' | 'outbound_transfer_failure' | 'charge_fee' | 'refund_fee' | 'account_fee' | 'payment_method_fee' | 'tilled_fee'
