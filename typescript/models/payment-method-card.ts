...
export interface PaymentMethodCard {
     ...
     * @memberof PaymentMethodCard
     */
    'funding'?: PaymentMethodCardFundingEnum;
    /**
...
type PaymentMethodCardBrandEnum = 'amex' | 'diners' | 'discover' | 'jcb' | 'maestro' | 'mastercard' | 'solo' | 'visa' | 'visa_debit' | 'visa_electron' | 'unknown'
type PaymentMethodCardFundingEnum = 'credit' | 'debit' | 'prepaid' | 'unknown'
