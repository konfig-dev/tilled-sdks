...
// @ts-ignore
import { BusinessLegalEntity } from './business-legal-entity';
// May contain unused imports in some cases
// @ts-ignore
...
type MerchantApplicationBusinessLegalEntityCategoryEnum = 'ACCT' | 'ART' | 'BEAUTY' | 'CATERING' | 'CHARITY' | 'CLEANING' | 'CONSULTANT' | 'CONTRACTOR' | 'DENTIST' | 'EDU' | 'FOOD' | 'LANDSCAPING' | 'LEGAL' | 'MEDICAL_PRACT' | 'MEDICAL_SERV' | 'MEMBERSHIP' | 'MISC_FOOD_STORES' | 'MISC_MERCH' | 'MISC_SERV' | 'MUSIC' | 'PC' | 'PHOTO_FILM' | 'PROF_SERV' | 'REAL_ESTATE' | 'RECREATION' | 'REPAIR' | 'RESTO' | 'RETAIL' | 'TAXI' | 'UTILITY' | 'VET' | 'WEB_DEV' | 'WEB_HOSTING' | 'OTHER'
type MerchantApplicationBusinessLegalEntityCurrencyEnum = 'aud' | 'cad' | 'dkk' | 'eur' | 'hkd' | 'jpy' | 'nzd' | 'nok' | 'gbp' | 'zar' | 'sek' | 'chf' | 'usd'
type MerchantApplicationBusinessLegalEntityLocaleEnum = 'en_US' | 'en_CA' | 'fr_CA' | 'en_GB'
type MerchantApplicationBusinessLegalEntityRegionEnum = 'US' | 'CA'
type MerchantApplicationBusinessLegalEntityTypeEnum = 'CHARITY' | 'CIC' | 'CORP' | 'LTD' | 'LLC' | 'LLP' | 'NPCORP' | 'PARTNERSHIP' | 'PLC' | 'GOV' | 'SOLEPROP' | 'TRUST'
type MerchantApplicationBusinessLegalEntityYearlyVolumeRangeEnum = 'LOW' | 'MEDIUM' | 'HIGH' | 'VERY_HIGH'
